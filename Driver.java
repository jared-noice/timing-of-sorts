   ...
   public static void main(String[] args){
      ...
      //}
         ...
         for(int i = 0; i < dataPointCount; i++){     //this is the amount of times the array is sorted
            ...
            //System.out.println("bubble " + i + " done");
            times[i] = bubbleTime;     //stores the time for that trial into the times array
            System.out.println((double)(times[i]/1000000.0) + " ms");      //prints the time and puts it at the required decimal location           
         }
      }
         ...
         for(int i = 0; i < dataPointCount; i++){
            ...
            //System.out.println("bubble " + i + " done");
            times[i] = heapTime;
            System.out.println((double)(times[i]/1000000.0) + " ms");             
         }
      }
